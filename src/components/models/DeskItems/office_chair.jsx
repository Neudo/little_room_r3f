...
Source: https://sketchfab.com/3d-models/office-chair-95160ce5a52f4e379f66527d2735d96c
Title: Office Chair
*/
...
export function OfficeChair(props) {
    const { nodes, materials } = useGLTF("./glb/chair.glb");
    return (
